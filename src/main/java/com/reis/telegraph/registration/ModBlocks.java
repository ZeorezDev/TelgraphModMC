...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TELEGRAPH_MACHINE = registerBlock("telegraph_machine",
            () -> new TelegraphBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
                    .strength(2.0f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> CABLE_BLOCK = registerBlock("cable_block",
            () -> new CableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOL)
                    .strength(1.0f).noOcclusion().requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> RELAY_STATION = registerBlock("relay_station",
            () -> new RelayStationBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
    ...
    public static final RegistryObject<Block> TELEGRAPH_POLE = registerBlock("telegraph_pole",
            () -> new TelegraphPoleBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD)
